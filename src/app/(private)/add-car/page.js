      ...
      <div className="bg-content1 border border-divider rounded-[24px] p-8 md:p-12 shadow-2xl">
        <form className="space-y-12" onSubmit={handleAddCar}>
          ...
          <div className="pt-6">
            <Button 
              size="lg" 
              className="w-full h-16 bg-primary hover:bg-primary/95 text-primary-foreground font-extrabold rounded-2xl shadow-xl transition-all duration-300 transform hover:scale-[1.01] text-base tracking-wider" 
              type="submit" 
              isLoading={isLoading}
            >
              List Vehicle
